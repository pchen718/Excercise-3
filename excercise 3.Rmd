...
The problem is the variety shows up multiple times since there are multiple plots. 
...
```
  Monday through Friday have the same looking graph for the weekdays. Saturday and Sundays graph look similar as well for the weekends.  
...
```
  ...
  In the first plot you can compare the distributions to each other showing how the rider times differ. In this plot it shows the proportion of the rides each category represents. 
